const Data = [
  ...
  {
    id: 3,
    name: "IIIT Bhubaneswar – Odisha",
    description: `
    The International Institute of Information Technology, Bhubaneswar (IIIT Bhubaneswar) is a premier technical university established in 2006 by the Government of Odisha with a focus on advancing education, research, and innovation in Information Technology and related fields.
    It operates under a unique public–private partnership model, combining strong academic foundations with industry-oriented training.
...

  {
    id: 4,
    name: "IIIT Allahabad",
    description: `IIIT Allahabad (IIITA), located in Prayagraj, Uttar Pradesh, is an Institute of National Importance established in 1999. It was founded to serve as a center of excellence in the rapidly advancing fields of Information Technology (IT) and Electronics and Communication Engineering (ECE), along with allied domains including Management and Applied Science.
  ...
  {
    id: 9,
    name: "📐 IIITDM Kancheepuram – Tamil Nadu",
  ...
  {
    id: 10,
    name: "💡 IIITDM Jabalpur – Madhya Pradesh",
  ...
  {
    id: 11,
    name: "💎 IIITDM Kurnool – Andhra Pradesh",
    description: `
  ...
  {
    id:12,
    name: "🏔️ IIIT Una – Himachal Pradesh",
    description: `
  ...
  {
    id: 14,
    name: "🌴 IIIT Sri City (IIITSRI) – Andhra Pradesh",
